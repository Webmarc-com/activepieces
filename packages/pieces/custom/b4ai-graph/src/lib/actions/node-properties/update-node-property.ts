...
import { GraphNodeProperty, UpdateNodePropertyRequest } from '../../common/types';

export const updateNodeProperty = createAction({
  auth: graphAuth,
  name: 'update_node_property',
  displayName: 'Update Node Property',
  description: 'Update an existing node property',
  props: {
  ...
  async run(context) {
    ...
    const body: UpdateNodePropertyRequest = {};
