...
import { GraphRelationshipProperty } from '../../common/types';

export const getRelationshipProperty = createAction({
  auth: graphAuth,
  name: 'get_relationship_property',
  displayName: 'Get Relationship Property',
  description: 'Get details of a specific relationship property by ID',
  props: {
